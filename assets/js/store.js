...
(function () {
  ...
  function applyRemoteData(data) {
    ...
    if (typeof data.whatsappNumber === 'string' && data.whatsappNumber.trim() !== '') set(KEYS.WHATSAPP_NUMBER, data.whatsappNumber.trim());
  }
  ...
  window.Store = {
    ...
    getPayloadForSync: function () {
      return {
        ...
        whatsappNumber: (get(KEYS.WHATSAPP_NUMBER, '') || '').trim() || undefined
      };
    },
    ...
    getWhatsappNumber: function () {
      var num = (get(KEYS.WHATSAPP_NUMBER, '') || '').trim().replace(/\D/g, '');
      return num || null;
    },
    setWhatsappNumber: function (num) {
      var cleaned = (num && String(num).trim()) ? String(num).trim().replace(/\D/g, '') : '';
      set(KEYS.WHATSAPP_NUMBER, cleaned);
    },

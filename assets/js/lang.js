...
(function () {
  ...
  var translations = {
    ...
    notesPlaceholder: 'Any special delivery instructions or notes...',
      ...
      whatsappNumberNotSet: 'WhatsApp number is not set. Please ask the store owner to set it in the Admin Dashboard.',
    ...
    notesPlaceholder: 'تعليمات توصيل أو ملاحظات...',
      ...
      whatsappNumberNotSet: 'لم يتم تعيين رقم واتساب. يرجى الطلب من صاحب المتجر تعيينه في لوحة التحكم.',
